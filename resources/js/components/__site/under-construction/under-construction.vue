    ...
    <div class="flex-center flex-column full-height-vh" :class="{ body_warning: wrongCode, body_success: success }">
        ...
        <div v-if="click < 5" style="max-width:540px">
            ...
            <div class="text-center sub-text trans">
                Бананыч ушёл на реконструкцию. Будет улучшаться для вас и скоро станет нормальным удобным сайтом 🙂  мы очень стараемся доделать все максимально быстро и обязательно напишем вам, когда будем готовы опять вас радовать! 
                <br><br>
