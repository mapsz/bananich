<template>
    <div 
        class="flex-center flex-column full-height-vh" 
        :class="{ body_warning: wrongCode, body_success: success }" 
        style="background-image: url(/images/ny.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;"
    >
        ...
        <div v-if="click < 5" style="max-width:540px">
            ...
            <div class="text-center sub-text trans" style="    
                margin: 10px;
                padding: 10px;
                background: #000000a3;
                color: white;
                ...
                border-radius: 10px;"
            >
                <!-- Скоро здесь будет что-то очень интересное <span @click="click++">🦃</span> -->
                <!-- Здравствуйте! Спасибо что заглянули! Сейчас Бананыч улучшается для вас. К утру заработает! Возвращайтесь, будем вас ждать. <span @click="click++">🙂</span> -->
                ...
                Бананыч желает вам приятного и легкого 2021 года! <span @click="click++">🎄</span><br>
                Мы откроемся для приема заказов 4 января, а первые доставки начнем осуществлять с 6 января. 
                
                <br><br>

                <span style="font-size: 8pt;">
                    Вы всегда сможете с нами связаться по телефону 8-921-944-41-37 или через наше сообщество во Вконтакте
                </span>
