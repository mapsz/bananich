  ...
  <div v-show="product.calories > 0" class="col-md-12 order-2 order-md-1 mt-4">                  
    <div class="calories">
      ...
      <div class="row">
        ...
        <!-- БЖУ -->
        <div class="col-12 col-lg-6 calories-scale">
    ...
    return [
      {
        ...
        percent:Math.round(this.product.carbohydrates / 100 * 100),
      },
      {
        caption:'Жиры',
        color:'green',
        ...
        percent:Math.round(this.product.fats / 100 * 100),
      },
      {
        caption:'Белки',
        color:'blue',
        ...
        percent:Math.round(this.product.proteins / 100 * 100),
      },
    ];
  }
},
