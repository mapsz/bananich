...
computed:{
  ...
  announces(){
    ...
    if(
      ...
      statics.push(
        {'_body':'Обратите внимание, что в накладную будет также включен сервисный сбор. С тарифами можно ознакомиться <a href="/welcome#prices">тут</a>'}
      );
    }
    ...
    // ){
    //   statics.push(
    //     {'_body':'Обратите внимание, что в накладную будет также включен сервисный сбор. С тарифами можно ознакомиться <a href="/welcome">тут</a>'}
    //   );
    // }
    ...
    if(
      ...
      statics.push(
        {'_body':'Вы можете внести изменения в адрес, дату и время доставки пока никто в нее не вступил'}
      );
    }
