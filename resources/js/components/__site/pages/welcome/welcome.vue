    ...
    <juge-main>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-12 col-lg-6 mb-3">
            Это новый подход к рациональному потреблению
            Neolavka дает возможность приобрести все товары нашего магазина по закупочным ценам в один из предложенных нами интервалов. Вы оплачиваете только сервисный сбор, который мы взимаем за то, что купили, отобрали и доставили вам заказ. 
            За счет оптимизации логистики мы существенно снижаем наши расходы. Это позволяет нам зарабатывать не на стоимости товаров, а только на сервисном сборе. Вы выбираете удобный для вас интервал из предложенных нами. 
            В бОльшей части города стоимость сервисного сбора (включает доставку) составляет 300 рублей. 
            ...
            <a href="/delivery_and_price">тут</a>.
          </div>
