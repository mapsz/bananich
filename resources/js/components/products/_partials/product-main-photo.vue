...
<div>
  ...
  <b-button v-b-modal.product-main-photo-modal>Редактировать главное фото</b-button>

  <div class="new-main-photo my-2 d-flex">

    <!-- Current main photo -->
    <img :src="product.mainImage" style="width:75px; height:75px">
  ...
  <b-modal v-model="modalShow" size="lg" id="product-main-photo-modal" title="Редактирование главного фото" ok-only>

      <!-- Photo list -->
      <div class="photo-list row">
        <img v-for='(image,i) in product.images' @click="edit(image)" class="m-2 border" :key='i' :src="image" >
      </div>
      ...
      <div v-show="selected" class="row">
        ...
        <div class="border" style="max-height: 400px; max-width:400px;">
          <img :src="'/products/images/source/1681_0.jpg'" id="photo-edit-place">
        </div>
  ...
  methods:{
    ...
    async save(){
      ...
      canvas.toBlob(async (blob) => {
        ...
        r = await ax.fetch('/product/main/photo',{file:r,productId:this.product.id},'post');
