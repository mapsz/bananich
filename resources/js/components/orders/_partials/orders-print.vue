          ...
          <div class="modal-body">            
            ...
            <div class="print-place">
              ...
              >                
                ...
                <div v-if="order.type == 'x'" class="mx-5">
                  <div style="font-size:11pt">
                    <b>
                      Если вам понравился наш сервис, расскажите о нем в сторис Инстаграм, упомянув наш аккаунт. И получите к следующему заказу подарок на выбор:
                    </b>
                  </div>

                  <div class="mt-3" style="font-size:10pt">
                    <ul>
                      <li>50 гр любого чая с сайта на выбор</li>
                      <li>100гр любого кофе на выбор</li>
                      <li>100 гр натурального вяленого манго</li>
                      <li>200гр ореховой смеси</li>
                      <li>200 гр чайной смеси</li>
                      <li>300 гр шоколадных фиников</li>
                    </ul>
                  </div>
