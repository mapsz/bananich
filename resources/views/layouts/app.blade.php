...
<!-- End Facebook Pixel Code -->
    ...
    <title>    
        {{ strpos($_SERVER['SERVER_NAME'], '.loc') !== false ? 'í ¼í¾¢LOCALí ¼í¾¢' : '' }}
        {{ strpos($_SERVER['SERVER_NAME'], 'bananich.') !== false ? 'Bananich í ¼í½Œ' : '' }}
        {{ strpos($_SERVER['SERVER_NAME'], 'neolavka.') !== false ? 'Neolavka í ¼í¼¿' : '' }}
    </title>
